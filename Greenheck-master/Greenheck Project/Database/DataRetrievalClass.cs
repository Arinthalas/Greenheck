...
namespace Greenheck_Project.Database
{
    class DataRetrievalClass
    {
        ...
        private const string dbA = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=H:\private\Greenheck-master\CIS 480 Capstone\CIS 480 Capstone\Greenheck Project\Greenheck Project\Database\Database1.mdf";
        ...
        public static List<Quarter> GetQuarter()
        {
            ...
            //fetch.CommandText = "SELECT * FROM QuarterTable";
            fetch.CommandText = "SELECT * FROM FocusComments";
            ...
            while (list.Read())
            {
                ...
                thus.fiscQuarter = Convert.ToInt32(list["FiscalQuarter"]);
                thus.statusCancelled = Convert.ToInt32(list["Cancelled"]);
                thus.statusComplete = Convert.ToInt32(list["Completed"]);
                thus.statusDelay = Convert.ToInt32(list["Delayed"]);
                thus.statusInProgress = Convert.ToInt32(list["InProgress"]);
