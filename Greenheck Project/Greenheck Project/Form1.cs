...
using Greenheck_Project.User_Interface;
    ...
    public partial class Form1 : Form
    {
       ...
       //auto-fills the drop-down boxes with existing data from the database
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                dgvOverview.Rows.Add(q.fiscYear.Year, q.fiscQuarter, q.statusNotStart, q.statusInProg, q.statusComplete, q.statusDelay, q.statusAxed);
            }
        ...
        {
            DetailsForm next = new DetailsForm();

            next.passedInfo = Int32.Parse(dgvOverview.CurrentCell.Value.ToString());
            next.passedYear = Int32.Parse(dgvOverview.CurrentRow.Cells[0].ToString());
            next.passedQuarter = Int32.Parse(dgvOverview.CurrentRow.Cells[1].ToString());
