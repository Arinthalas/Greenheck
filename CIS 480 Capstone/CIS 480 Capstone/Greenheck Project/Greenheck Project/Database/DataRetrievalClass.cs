...
namespace Greenheck_Project.Database
{
    class DataRetrievalClass
    {
        ...
        private const string dbA = @"Data Source = (LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\CIS 480 Capstone\CIS 480 Capstone\Greenheck Project\Greenheck Project\Database\Database1.mdf";
